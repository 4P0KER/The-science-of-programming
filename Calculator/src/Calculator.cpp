...
std::string Calculator::extractWord(const std::string& str, size_t& pos) const {
    std::string word;
...
double Calculator::parseNumber(const std::string& str, size_t& pos) const {
    std::string numStr;
...
void Calculator::registerFunction(const std::string& name, UnaryFunctionPtr func) {
    functions[name] = func;
}
